...
//             className="outline-none bg-transparent border-2 border-emerald-600 font-medium text-lg py-2 px-6 rounded-full placeholder:text-gray-400 gap-"
//           />
//           <input 
//             type="password"
//             value={password}
...
//             className="outline-none bg-transparent mt-4 border-2 border-emerald-600 font-medium text-lg py-2 px-6 rounded-full placeholder:text-gray-400"
//           />
//           <button 
//             type="submit"
//             className="mt-4 text-white rounded-full border-none outline-none hover:bg-emerald-700 font-semibold bg-emerald-600 text-lg py-2 px-8 w-full placeholder-text-white" 
//           >
//             Login
//           </button>
//         </form>
